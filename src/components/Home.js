...
function Home() {
    ...
    return(
        ...
        <Link to='/ItemDetailConteiner/Protección' className='linkCard col-12'>
        ...
        <div className='home_containerCard card  mx-1 my-1' >
        <Link to='/ItemDetailConteiner/Doboks' className='linkCard col-12'>
        ...
        <div className='home_containerCard card  mx-1 my-1' >
        <Link to='/ItemDetailConteiner/Manoplasypalchaguis' className='linkCard col-12'>
